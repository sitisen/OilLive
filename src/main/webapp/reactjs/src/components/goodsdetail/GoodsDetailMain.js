...
const GoodsDetailMain = () => {
    ...
    const insertBasket = () => {
        ...
        const goodsCode = goodsInfo.GOODS_CODE; // 사용자가 선택한 상품 코드
    ...
    const goodsData = Object.assign({goodsCode: goodsInfo.GOODS_CODE}, { goodsSelectedAmount: amount }, { basketCode: null });
